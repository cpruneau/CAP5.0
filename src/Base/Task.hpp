...
protected:
  ...
  long   taskExecuted;
  String taskDbPath;
  String taskProjectPath;
  String taskDataImportPath;
  String taskDataExportPath;
  String taskHistosImportPath;
  String taskHistosExportPath;
...
public:
  ...
  //!
  //! Save the histogram groups owned by this task instance at:
  //! histosExportPath,   histosExportFile
  //!
  virtual void exportHistograms();

  //!
  //! Save the histogram groups owned by this task instance at:
  //! exportPath,   histosExportFile
  //!
  virtual void exportHistograms(const String & exportPath);
  ...
  //!
  //! Save the histogram groups owned by this task instance to the given root file.
  //!
  virtual void exportHistograms(TFile & outputFile);

  //!
  //! Save the histogram groups owned by this task instance to the given  file.
  //!
