...
//bool therminatorUseDateSeed = true;
//int  therminatorSeed        = 14142793;
//TRandom * therminatorRandom = nullptr;
//
//void setRandomSeed(int v)
//{
//  therminatorUseDateSeed = false;
//  therminatorSeed = v;
//}
//
//TRandom * getRandom()
//{
//  if (therminatorRandom==nullptr)
//    {
//    TRandom2 * r = new TRandom2();
//    if (therminatorUseDateSeed)
//      {
//      TDatime tDate;
//      auto v = tDate.get();
//#ifdef _ROOT_4_
//      r->setSeed2(v, (v% 11) * 7 + (tDate.get() / 7));
//#else
//      r->setSeed(v);
//#endif
//      }
//    else
//      {
//      r->setSeed(therminatorSeed);
//      }
//    therminatorRandom = r;
//    }
//  return therminatorRandom;
//}
...
static const int kFileNameampxChar = 2000;
 ...
 * @brief Integer returned by Hypersurface_Library if VectorField inforamption is not found.
 *
