...
#define _EVENTS_FORampT_ "eventid/i:entries:entriesprev"
 ...
 * @brief ampcro with the number of events stored per file.
 * 
 * @def _EVENTS_TREE_
 * @brief ampcro with the name of the <a href="http://root.cern.ch/root/html/TTree.html">TTree</a> with event inforamption.
 * 
 * @def _EVENTS_BRANCH_
 * @brief ampcro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a> in the TTree with StructEvent.
 * 
 * @def _EVENTS_FORampT_
 * @brief ampcro with the forampt of StructEvent.
 */
/*! @struct StructEvent
