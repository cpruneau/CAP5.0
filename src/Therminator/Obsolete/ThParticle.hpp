 ...
 * 
 * Class has inforamption about the PDG Monte-Carlo number of the ParticleType, father particle and the original primordial particle
 ...
 * Particle also holds inforamption if the particle has decayed.
 *
 ...
 * 
 * @fn const char* Particle::ampkeTEXTEntry()
