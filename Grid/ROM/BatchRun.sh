...
# CAP_GRID_ROM                           : Location of grid scripts for ROM slurm grid
...
export CAP_GRID_ROM="$CAP_ROOT/Grid/ROM/"
...
export CAP_OUTPUT_PATH="$CAP_GRID_ROM"
...
do
  ...
  sbatch -J batch__CAP -q primary --array=1-$NSUBJOBS --chdir=$CAP_WORKINGDIRECTORY --time=05:00:00 --mem=2G -o $CAP_WORKINGDIRECTORY/Job_%A_%a.out -e $CAP_WORKINGDIRECTORY/Job_%A_%a.err $CAP_GRID_ROM/RunAna.sh
  sleep 2s
done
